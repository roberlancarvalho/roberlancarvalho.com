...
export default function GalleryPage() {
  return (
    <div>
      <div className="mx-auto max-w-[70rem] px-4 pt-8 large:px-8">
        <h1 className="text-3xl font-bold text-post">Galeria de Fotos</h1>
        <p className="mt-2 text-texts">
          Explore algumas fotos de eventos, hobbies e momentos especiais.
        </p>
      </div>
